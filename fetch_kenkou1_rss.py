...
# -*- coding: utf-8 -*-
"""
近江八幡市立総合医療センター(kenkou1.com) の公式RSSを取得し、
rss_items.json / rss.xml にマージするスクリプト。

このサイトは公式にRSSを配信しているため、スクレイピングは不要。
"""
...
SOURCE_RSS_URL = "https://www.kenkou1.com/news.xml"
...
def main():
    ...
    print(f"近江八幡市立総合医療センター: 新着 {len(new_items)}件")
